    ...
    <section class="content-main">
        <div class="row">
            ...
            <div class="container mt-5">
                ...
                <form method="POST" action="/admin/grower/edit">
                    @csrf
                    <input type="text" hidden name="id" value="{{$grower_info->id}}">
                    <div class="row mt-10">
                    ...
                    <button type="submit" class="btn btn-primary mt-15">Edit Grower</button>
                </form>
            </div>
...
<script>
alert('Edited Grower Successfully!');
</script>
